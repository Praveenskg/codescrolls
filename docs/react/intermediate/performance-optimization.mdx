...
sidebar_position: 3
description: Learn React performance optimization techniques including React.memo, useMemo, useCallback, code splitting, and lazy loading.
keywords: [react performance, optimization, react memo, useMemo, useCallback, code splitting, lazy loading, react profiler]
---

# Performance Optimization in React

**Performance optimization** ensures your React app runs smoothly and efficiently. Learn techniques to prevent unnecessary re-renders and improve load times.

---

## 🆕 React 19: React Compiler

React 19 introduces the **React Compiler** - an automatic optimization tool that handles memoization for you.
...
- ✅ Improves build-time performance
...
**Optimize wisely for a fast, smooth user experience!** 🚀
