...
sidebar_position: 6
description:
  Master TypeScript with React including component typing, hooks, props, events,
  and best practices for type-safe React applications.
keywords:
  [
    typescript react,
    react typescript,
...
TypeScript and React work together to provide **type-safe, maintainable** React
applications. Learn how to type components, hooks, props, and events.
...
:::tip Modern React prefers **not using `React.FC`** as it has some limitations.
Use regular function components instead. :::
...
// ❌ Avoid - React.FC has limitations
// - Implicitly adds children prop
// - Doesn't work well with generics
// - Can cause issues with defaultProps
...
- Implicitly adds `children?: React.ReactNode` prop
- Doesn't work well with generic components
- Can cause issues with `defaultProps` (deprecated in React 19)
- Less flexible than regular function components
...
- [React Hooks](/docs/react/intermediate/hooks)
