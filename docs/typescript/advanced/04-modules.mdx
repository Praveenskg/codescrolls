...
sidebar_position: 4
description: Master TypeScript modules with ES6 imports/exports, default exports, namespaces, and module resolution strategies.
keywords: [typescript modules, es6 modules, import export, typescript namespaces, module resolution, typescript imports]
---

# Module System in TypeScript

TypeScript uses **ES6 module syntax** for organizing code into reusable pieces. Modules help maintain code organization, encapsulation, and reusability.
...
:::caution
Namespaces are legacy. Prefer ES6 modules for new code.
:::
