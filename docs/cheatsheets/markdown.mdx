...
```markdown
[Codescrolls](https://codescrolls.vercel.app)
```
...
> Note: Not supported in GitHub Markdown.
...
```markdown
[CodeScrolls](https://codescrolls.vercel.app 'Visit CodeScrolls for developer docs')
```
...
```markdown
<https://codescrolls.vercel.app> <email@example.com>
```

**Output:**

{/* Auto-links are automatically converted to clickable links */}
https://codescrolls.vercel.app  
email@example.com
...
| Autolinks        | Yes    | Yes    | Yes        | Yes        |
| Footnotes        | Yes    | Yes    | Yes        | No         |
| Definition Lists | No     | Yes    | No         | No         |
| Math             | Yes    | Yes    | Yes        | No         |
| Admonitions      | No     | No     | Yes        | No         |
