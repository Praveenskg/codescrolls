...
description:
  Essential CSS properties, selectors, layouts, animations, and responsive
  design patterns
keywords:
  [css, cheatsheet, styling, layout, responsive, animations, flexbox, grid]
sidebar_position: 3
---
...
A comprehensive quick reference guide for CSS properties, selectors, layouts,
animations, and modern CSS features.

---

:::info CSS (Cascading Style Sheets) is the language used to style web pages and
...
.bg-advanced {
  background-image:
    url('pattern.png'), linear-gradient(to right, #ff6b6b, #4ecdc4);
  background-size:
    50px 50px,
    cover;
...
.good-selector .element {
} /* ✅ Fast */
.bad-selector * .element {
} /* ❌ Slow */
