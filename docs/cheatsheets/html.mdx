...
A comprehensive reference guide for HTML elements, attributes, semantic markup, and best practices.
...
<meter id="meter" value="0.8" min="0" max="1" low="0.2" high="0.8" optimum="0.5">
  80%
</meter>
