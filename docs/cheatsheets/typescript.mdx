...
description:
  Essential TypeScript syntax, types, and patterns - Quick reference guide
...
A quick reference guide for essential TypeScript syntax, types, interfaces, and
patterns.

---

:::info TypeScript is a superset of JavaScript that adds static typing and
powerful tooling.
