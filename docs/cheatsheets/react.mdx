...
//  Not always a problem; optimize only when identity stability matters
<Component style={{ margin: 10 }} />;

// Better when passing to memoized children or dependency arrays
...
//  DO: Optimize with memo/useCallback only when profiling shows a need
...
**Master React for building modern user interfaces!**
