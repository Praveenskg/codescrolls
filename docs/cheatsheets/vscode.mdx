...
A comprehensive cheat sheet to help you boost productivity with Visual Studio
Code.
...
<!-- Advanced -->
div.container>header>nav>ul>li*4>a[href="#$"]{Link $}+main>section*3>h2{Section
$}+p{Lorem ipsum}
...
:::tip Pro Tip Master the Command Palette (`Ctrl/Cmd + Shift + P`). It's your
VSCode superpower. You can access almost any feature through it! :::

:::note Advanced Users For power users, consider learning VSCode's extension API
to create custom extensions for your specific workflows. :::
