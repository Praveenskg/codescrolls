---
id: html-overview
title: HTML Tutorial and Documentation (Beginner to Advanced)
description:
  Learn HTML from basics to advanced with semantic markup, forms, multimedia,
  accessibility, and modern HTML5 APIs through practical examples.
keywords:
  [
    html tutorial,
    learn html,
...
1. **[HTML Elements](./basics/elements.mdx)** - Core HTML elements and their
   uses
2. **[HTML Attributes](./basics/attributes.mdx)** - Adding properties to
   elements
