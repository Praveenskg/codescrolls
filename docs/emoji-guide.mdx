...
description: Complete guide to using emojis consistently across CodeScrolls documentation and blog posts. Learn emoji conventions for sections, features, and content types.
sidebar_position: 2
---
