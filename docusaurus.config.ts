...
const config: Config = {
  ...
  url: 'https://codescrolls.vercel.app',
  baseUrl: '/',
  ...
  headTags: [
    ...
    // Enhanced Organization Schema with more details
    {
      ...
      innerHTML: JSON.stringify({
        ...
        logo: {
          '@type': 'ImageObject',
          url: 'https://codescrolls.vercel.app/img/logo.png',
          width: 512,
          height: 512,
        },
        description:
        ...
        contactPoint: {
          ...
          url: 'https://codescrolls.vercel.app/contact',
        },
        sameAs: [
    ...
    // WebSite Schema with SearchAction
    {
      ...
      innerHTML: JSON.stringify({
        ...
        potentialAction: {
          ...
          target: {
            '@type': 'EntryPoint',
            urlTemplate: 'https://codescrolls.vercel.app/search?q={search_term_string}',
          },
  ...
  themeConfig: {
    ...
    metadata: [
      ...
      { property: 'og:url', content: 'https://codescrolls.vercel.app' },
      { property: 'og:image', content: 'https://codescrolls.vercel.app/img/opengraph.png' },
      {
        property: 'og:image:secure_url',
        content: 'https://codescrolls.vercel.app/img/opengraph.png',
      },
      ...
      { name: 'twitter:image', content: 'https://codescrolls.vercel.app/img/opengraph.png' },
      { name: 'twitter:image:alt', content: 'CodeScrolls - Web Development Documentation' },
      { name: 'twitter:domain', content: 'codescrolls.vercel.app' },
