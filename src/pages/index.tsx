        ...
        <section className={styles.categories}>
          ...
          <div className={styles.grid}>
            <Link to="/docs/javascript" className={styles.card}>
              <img src={useBaseUrl('/img/skills/JavaScript.svg')} alt="JavaScript" className={styles.cardIcon} />
              JavaScript
            </Link>
            <Link to="/docs/typescript" className={styles.card}>
              <img src={useBaseUrl('/img/skills/TypeScript.svg')} alt="TypeScript" className={styles.cardIcon} />
              TypeScript
            </Link>
            <Link to="/docs/react" className={styles.card}>
              <img src={useBaseUrl('/img/skills/React-Dark.svg')} alt="React" className={styles.cardIcon} />
              React
            </Link>
            ...
            <Link to="/docs/database" className={styles.card}>
              <img src={useBaseUrl('/img/skills/Supabase-Light.svg')} alt="Database" className={styles.cardIcon} />
              Databases
            </Link>
            <Link to="/docs/linux" className={styles.card}>
              <img src={useBaseUrl('/img/skills/Linux-Light.svg')} alt="Linux" className={styles.cardIcon} />
              Linux
            </Link>
          </div>
        </section>
